...
public class UserLoginPage {
    ...
    /**
     * Construct a UserLoginPage.
     * @param databaseHelper database helper for user operations
     */
    ...
    /**
     * Show the login UI in the provided stage.
     * @param primaryStage the Stage to display the login UI
     */
